            ...
            async editaudit(
              ...
              @UploadedFile() file: Express.Multer.File,
                ...
                try{
                  ...
                  await this.prisma.audit.update({where: {id: body.id}, data:{
                      responsableId: parseIntbody.responsableId,
                      type: body.type,
                      processus: body.processus,
                      planningDate: body.planningDate,
                      realisationDate: body.realisationDate,
                      lieu: body.lieu,
                      path: filePath,
                    }})
                    ;
                  if (file){
                    ...
                    await this.prisma.audit.update({where: {id: body.id}, data:{ status: 2}})
                  }
            }catch(error){
