...
import NewIndicateur from './Components/Indicateur/NewIndicateur';
import IndicateurList from './Components/Indicateur/IndicateurList';
...
import Qualiff from '../src/Components/Assets/Logo QualIff couleur.png';
import './App.css';
    ...
    <Router>
      ...
      {isLoading ? (
        ...
        <Navbar>
            ...
            <Navbar.Brand className="quali" href="/">
              <img
                src={Qualiff}
                alt="QualIFF Logo"
                style={{ height: '160px', width: 'auto' }} // Adjust the size as needed
              />
            </Navbar.Brand>
          ...
          <Routes>
            ...
            {isLoggedIn && (
              <>
                ...
                <Route
                  path="/audit_info"
                  element={isLoggedIn ? <AuditInfo /> : <Navigate to="/" />}
                />
                <Route
                  path="/Nouvel_Audit"
                ...
                />
                <Route
                  path="/Nouvel_indicateur"
                  element={isLoggedIn ? <NewIndicateur /> : <Navigate to="/" />}
                />
                <Route
                  path="/Indicateur_de_performance"
                  element={isLoggedIn ? <IndicateurList /> : <Navigate to="/" />}
                />
                <Route
                  path="/Journal_damelioration"
