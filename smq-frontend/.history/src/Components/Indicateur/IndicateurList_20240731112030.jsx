...
const IndicateurList = () => {
  ...
  <button onClick={handleFilter}>Filter</button>
      ...
      <div>
        <a  className="newIndicateurs" href="/newAction" > Ajouter</a>
      </div>
      ...
      {filteredActions.map(indicateur => (
        <div key={indicateur.id} className="Actions">
          <p>{indicateur.code}</p>
          <p>{indicateur.status}</p>
          <p>{indicateur.libelle}</p>
          <p>{indicateur.type}</p>
          <p>{indicateur.priorite}</p>
          <p>{indicateur.echeance}</p>
          <p>{indicateur.cout}</p>
        </div>
      ))}
    </div>
