...
const NewIndicateur = () => {
  ...
  const renderTFields = (frequence) => {
    switch (frequence) {
      case 'mensuelle':
        return Array.from({ length: 12 }, (_, i) => <div key={i} className="t-field">T{i + 1}</div>);
      case 'trimestrielle':
        return Array.from({ length: 4 }, (_, i) => <div key={i} className="t-field">T{i + 1}</div>);
      case 'semestrielle':
        return Array.from({ length: 2 }, (_, i) => (
          <div key={i} className="t-field">T{i * 2 + 1} - T{i * 2 + 2}</div>
        ));
      case 'annuelle':
        return <div className="t-field">T1 - T4</div>;
      default:
        return null;
    }
  };
