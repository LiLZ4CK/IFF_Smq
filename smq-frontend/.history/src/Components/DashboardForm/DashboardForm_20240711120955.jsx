...
const Sublinks = [
  ...
  { label: 'Indicateur',link1: 'Nouvel indicateur', link2: 'TBD', link3: 'Indicateur de performance' },
];
 ...
 // const fetchuserrole = async 
  ...
  <div className="header-buttons">
    <div class="Head">
      ...
      <a class="header-button" href="Gestion_des_risques">Journal d'amelioration (plan d'action)</a>
    </div>
  </div>
