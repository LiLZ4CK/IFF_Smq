                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {showDescription ? (
                        <div className="descriptionNC">
                            ...
                            />
                            <label htmlFor="Ref">Action Immédiate</label>
                            <input
                                name="Ref"
                                id="Ref"
                                value={sActionImm}
                                onChange={(e) => setActionImm(e.target.value)}
                        ...
                        <div className="actionImm">
                        <label htmlFor="actionImm">Action Immédiate</label>
                        {actionImm.map((action, index) => (
                            <div key={index}>
                                <input
                                    type="text"
                                    value={action}
                                    onChange={(e) => handleAdditionalActionChange(e, index)}
                                    placeholder={`Action Immédiate`}
                                />
                                <button type="button" onClick={() => removeAction(index)}>Remove</button>
                            </div>
                        ))}
                        <button type="button" onClick={() => addNewAction()}>Add Action</button>
                    </div>
                    )}
                    <button
                        type="reset"
