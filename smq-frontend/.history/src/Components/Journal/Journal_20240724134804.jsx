          ...
          return (
            <form>
              ...
              <div className="Journal-row">
                <div className="Journal-group left">
                  <label>Constat</label>
                  <textarea type="text" className="Journal-control"  
                    value={constat}
            ...
            <form>                
              <div className="Journal-row">
                <div className="Journal-group left">
                  ...
                  <textarea className="Journal-control" rows="3" 
                    value={analyse}
              ...
              <div className="Journal-row">
                <div className="Journal-group left">
                  ...
                  <input className="Journal-control" type="date"  
                    value={delaiTrait}
            ...
            <form>                
              <div className="Journal-row">
                <div className="Journal-group left">
                  ...
                  <input className="Journal-control" rows="3" 
