...
const Journal = () => {
    ...
    const ['Action efficace (Oui/Non)   , setActionEfficace  ] = useState('');
      ...
      switch (phase) {
              ...
              <div className="form-row">
                <div className="form-group left">
                  ...
                  <textarea className="form-control" rows="3" 
                    value={typeConstat}
                    onChange={(e) => setTypeConstat(e.target.value)}></textarea>
                </div>
                <div className="form-group left">
                  <label>Origine</label>
                ...
                <div className="form-group right">
                  <label>Date</label>
                  <textarea className="form-control" rows="3" type="Datetime"
                    value={date}
          ...
          return (
            <form>
              ...
              <div className="form-group left">
                ...
                <div className="form-group right">
                  <label>Type d'action ( correctives, correction( immédiate), amélioration)</label>
                  <input type="text" className="form-control" 
                    value={typeAction}
        ...
        case 3:
          return (
            <form>
              <div className="form-group">
                <label>Action efficace (Oui/Non)</label>
                <textarea className="form-control" rows="3" 
                    value={comments}
