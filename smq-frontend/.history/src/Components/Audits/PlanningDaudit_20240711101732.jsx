    ...
    try {
      ...
      if (args.requestType === 'eventChanged') {
        const auda = {
          ...
          respo: document.querySelector('input[name="Responsable"]').value,
        ...
        const aud = {
          ...
          type: document.querySelector('input[name="Type"]').value,
          desc: document.querySelector('input[name="Description"]').value,v
          start: document.querySelector('input[name="StartTime"]').value,
          end: document.querySelector('input[name="EndTime"]').value,
        };
        try {
        ...
        <table className="custom-event-editor" lang='fr'>
          <tbody>
            ...
            <tr>
              ...
              <td><select name="Responsable" id="custom" value={props.Responsable} required >
                    <option value="" disabled selected={selectedPross === ""}>Nom de Resposable</option>
