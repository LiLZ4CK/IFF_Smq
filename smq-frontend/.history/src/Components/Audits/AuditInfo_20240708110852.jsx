        ...
        <div className='auditinfo'>
          ...
          <div className="info-row">
            ...
            <div className="info-row">
              ...
              <input type="text" name="responsable" value={selectedAudit.responsableId || ''} onChange={handleInputChange} />
            </div>
            <div className="info-row">
              <label>Type:</label>
              <input type="text" name="type" value={selectedAudit.type || ''} onChange={handleInputChange} />
            </div>
            <div className="info-row">
              <label>Processus:</label>
              <input type="text" name="processus" value={selectedAudit.processus || ''} onChange={handleInputChange} />
            </div>
            <div className="info-row">
