...
const AuditsList = () => {
  ...
  const addPdf = async(id) => {
    try{
      // Add your code for adding a PDF
    }
    catch(error){
  ...
  return (
    <div className="audits-list">
      <div>
        <a className="newAudit" href="/Nouvel_audit" >nouvel audit</a>
      </div>
      ...
      {selectedAuditId && <AuditInfo audid={selectedAuditId} />}
    </div>
  );
};
