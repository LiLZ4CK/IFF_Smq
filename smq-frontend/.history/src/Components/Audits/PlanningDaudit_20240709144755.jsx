...
const PlanningDauit = () => {
  ...
  console.log('Mapped Events:', eventss); // Add this line
  ...
  return (
    <main className="flex justify-center items-center min-h-screen">
      ...
      <div className="explanation">
        ...
        <span>Green (Realiser): This color indicates tasks or events that have been realized or completed.</span>
      </div>
      <div className="explanation">
        <div className="ylw"></div>
        <span>Yellow (Prevue): This color is used for tasks or events that are previewed or planned.</span>
      </div>
      <div className="explanation">
        <div className="org"></div>
        <span>Orange (En cours): This color represents tasks or events that are currently in progress.</span>
      </div>
    </div>
