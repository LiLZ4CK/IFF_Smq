  ...
  const Events = async (args) => {
    try {
      ...
      if (args.requestType === 'eventChanged') {
        ...
        formData.append('responsableId', args.data[0].responsable);
        formData.append('type', args.data[0].Type);
        formData.append('processus', args.data[0].Subject);
        formData.append('planningDate', args.data[0].StartTime);
        formData.append('realisationDate', args.data[0].EndTime);
        ...
        <table className="custom-event-editor" lang='fr'>
          <tbody>
            ...
            <tr>
              ...
              <td><input id="StartTime" name="StartTime" type="datetime-local" defaultValue={getDateString(props.StartTime)}/></td>
            </tr>
            <tr>
              <td className="EndTime">Date de réalisation</td>
              <td><input id="EndTime" name="EndTime" type="datetime-local" defaultValue={getDateString(props.EndTime)}/></td>
            </tr>
          </tbody>
        </table>
      );
