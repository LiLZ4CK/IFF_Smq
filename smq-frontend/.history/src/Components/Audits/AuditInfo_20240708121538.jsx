    ...
    const handleInputChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          formData.append('processus', audit.);
          formData.append('planningDate', audit.);
          formData.append('realisationDate', audit.);
          formData.append('lieu', service);
            ...
            const response = await fetch('http://localhost:3000/audits/edit', {
                ...
                body: JSON.stringify({ audita: updateddata })
            });
            if (response.ok) {
