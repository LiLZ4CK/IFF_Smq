...
const PlanningDauit = () => {
  ...
  const [selectedResponsableaj, setSelectedResponsableaj] = useState('');
  const [selectedPross, setSelectedPross] = useState("");
  const [selectedProssaj, setSelectedProssaj] = useState("");
          ...
          <tbody>
            <tr>
              ...
              <td><select
                        name="select"
                        id="select"
                        value={selectedProssaj}
                        onChange={(e) => setSelectedPross(e.target.value)}
                        required
                    >
                        <option value="" disabled selected={selectedProssaj === ""}>
                            Nom de Processes
                        </option>
            ...
            <tr>
              ...
              <td><select
                        name="select"
                        id="custom"
                        value={selectedResponsableaj}
                        onChange={(e) => setSelectedResponsableaj(e.target.value)}
                        required
                    >
