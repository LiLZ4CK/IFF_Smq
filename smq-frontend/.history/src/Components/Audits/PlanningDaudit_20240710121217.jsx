    ...
    try {
      ...
      if (args.requestType === 'eventChanged') {
        const auda = {
          ...
          start: new Date(document.querySelector('input[name="StartTime"]').value),
          end: new Date(document.querySelector('input[name="EndTime"]').value),
          ...
          <tbody>
            ...
            <td>
              <input 
                ...
                name="StartTime" 
                type="datetime-local" 
                defaultValue={formatDateForInput(props.StartTime)} 
              />
            </td>
          </tr>
          <tr>
            ...
            <td>
              <input 
                ...
                name="EndTime" 
                type="datetime-local" 
                defaultValue={formatDateForInput(props.EndTime)} 
              />
            </td>
          </tr>
          </tbody>
