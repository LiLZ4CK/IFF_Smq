...
const PlanningDauit = () => {
    ...
    const fetchAudits = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log('Fetched audits:', data.audits); // Log the fetched audits
        } else {
  ...
  useEffect(() => {
    console.log('audits state updated:', audits); // Log the updated audits state
  }, [audits]);
  ...
  console.log('events:', eventss); // Debug log
  console.log('audits:', audits); // Debug log
